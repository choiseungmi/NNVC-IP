...
class ReassignedDataset(data.Dataset):
    ...
    def __init__(self, image_indexes, pseudolabels, root, transform=None):
        ...
        self.samples = check_list(self.y_path)
    ...
    def __getitem__(self, index):
        ...
        img = np.zeros((above.shape[1], above.shape[1]), np.uint8)
        img[:above.shape[0], :above.shape[1]] = above
        img[above.shape[0]:, :above.shape[0]] = left
